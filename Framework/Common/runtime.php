...
defined('CORE_PATH') or define('CORE_PATH', THINK_PATH . 'Lib/'); // systemcoreLibrary catalog
defined('EXTEND_PATH') or define('EXTEND_PATH', THINK_PATH . 'Extend/'); // System extensions directory
defined('MODE_PATH') or define('MODE_PATH', EXTEND_PATH . 'Mode/'); // Directory schema extensions
defined('ENGINE_PATH') or define('ENGINE_PATH', EXTEND_PATH . 'Engine/'); // Extended engine directory
defined('VENDOR_PATH') or define('VENDOR_PATH', EXTEND_PATH . 'Vendor/'); // Third-party libraries directory
defined('LIBRARY_PATH') or define('LIBRARY_PATH', EXTEND_PATH . 'Library/'); // Extended library catalog
defined('COMMON_PATH') or define('COMMON_PATH', APP_PATH . 'Common/'); // Public directory project
defined('LIB_PATH') or define('LIB_PATH', APP_PATH . 'Lib/'); // Project library catalog
defined('CONF_PATH') or define('CONF_PATH', APP_PATH . 'Conf/'); // Project configuration directory
defined('LANG_PATH') or define('LANG_PATH', APP_PATH . 'Lang/'); // Project Language Pack directory
defined('TMPL_PATH') or define('TMPL_PATH', APP_PATH . 'Tpl/'); // projecttemplatetable of Contents
defined('HTML_PATH') or define('HTML_PATH', APP_PATH . 'Html/'); // The static directory
defined('LOG_PATH') or define('LOG_PATH', RUNTIME_PATH . 'Logs/'); // Log directory project
defined('TEMP_PATH') or define('TEMP_PATH', RUNTIME_PATH . 'Temp/'); // Cache directory project
defined('DATA_PATH') or define('DATA_PATH', RUNTIME_PATH . 'Data/'); // Project data directory
defined('CACHE_PATH') or define('CACHE_PATH', RUNTIME_PATH . 'Cache/'); // projecttemplateCachetable of Contents
