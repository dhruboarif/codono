...
function throw_exception($msg, $type='Think\\Exception', $code=0) {
    Think\Log::record('RecommendedEAlternative Methodsthrow_exception',Think\Log::NOTICE);
...
/**
 * fast file data Read with Storage For simple data types Strings, arrays
...
function think_send_mail($to, $name, $subject = '', $body = '', $attachment = null){
	...
	//var_dump($config['SMTP_HOST']);exit;
