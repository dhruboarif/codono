...
class Auth
{
    ...
    /**
     * Check permissions
     * @param name string|array  needverificationofruleList,stand bycommaSeparatedofCompetenceruleorindexArray
     * @param uid  int           Authenticated userid
     * @param string mode        carried outcheckModel
     * @param relation string    If 'or' ShowMeet any onerulewhich isbyverification;If 'and'It meansNeed to meetallruleTalentbyverification
     * @return boolean           By verifying returntrue;Failure to returnfalse
     */
