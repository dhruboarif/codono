...
return array(
    ...
    'DB_HOST' => 'localhost', // serveraddress
    'DB_NAME' => 'btccoin7',          // DatabaseName
    'DB_USER' => '1',      // username
    'DB_PWD' => '1',          // password
    'DB_PORT' => '',        // port
    ...
    'DATA_CACHE_PREFIX' => 'wG6QJ8_',     // CachePrefix unique prefix for security you can change it 
    ...
    'DATA_CACHE_KEY' => '',    // Cache file KEY (valid only for File mode cache)
    ...
    'TMPL_ACTION_ERROR' => THINK_PATH . 'Tpl/dispatch_jump.tpl', // defaulterrorJumpcorrespondingTemplate files
    'TMPL_ACTION_SUCCESS' => THINK_PATH . 'Tpl/dispatch_jump.tpl', // defaultsuccessJumpcorrespondingTemplate files
    'TMPL_EXCEPTION_FILE' => THINK_PATH . 'Tpl/think_exception.tpl',// abnormalpageofTemplate files
