...
class VoteController extends AdminController
{
    ...
    public function type($p = 1, $r = 15, $str_addtime = '', $end_addtime = '', $order = '', $status = '', $type = '', $field = '', $name = '')
    {
        ...
        $builder->keyText('coinname', 'Currencies');
        $builder->keyText('title', 'name');
        $builder->keyText('votecoin', 'Voting currency');
        $builder->keyText('assumnum', 'Deducting the amount');
        $builder->keyText('zhichi', 'Support Ticket');
    ...
    public function edit($id = NULL)
    {
        if (!empty($_POST)) {
            ...
            $builder->keyText('coinname', 'Currencies', 'English name');
            $builder->keyText('title', 'Display Name', 'Chinese name');
