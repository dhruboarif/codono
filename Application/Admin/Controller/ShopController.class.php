...
class ShopController extends AdminController
{
    ...
    public function index($p = 1, $r = 15, $str_addtime = '', $end_addtime = '', $order = '', $status = '', $type = '', $field = '', $name = '')
    {
        ...
        $builder->keyText('price', 'Offer price');
    ...
    public function edit($id = NULL)
    {
        if (!empty($_POST)) {
            ...
            $builder->keyText('price', 'Commodity price', 'decimal 2 points');
            $builder->keyText('market_price', 'market price', 'decimal 2 points');
    ...
    public function log($p = 1, $r = 15, $str_addtime = '', $end_addtime = '', $order = '', $status = '', $type = '', $field = '', $name = '')
    {
        ...
        $builder->keyShopid();
        $builder->keyText('price', 'Offer price');
        $builder->keyText('num', 'Order Quantity');
        $builder->keyText('mum', 'Total');
        $builder->keyText('coinname', 'Payment Currency');
        $builder->keyText('xuyao', 'Number of Payments');
        $builder->keyText('addr', 'Shipping address');
        $builder->keyText('sort', 'Sort');
        $builder->keyTime('addtime', 'add time');
        $builder->keyTime('endtime', 'Updated');
    ...
    public function reject($id = NULL)
    {
        ...
        $mo->execute('lock tables codono_user_coin write,codono_shop_log write');
