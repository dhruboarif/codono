...
class TextModel extends \Think\Model
{
    ...
    public function check_field($name = NULL)
    {
        if (!M('Text')->where(array('name' => $name))->find()) {
            M('Text')->add(array('name' => $name, 'content' => '<span style="color:#0096E0;line-height:21px;background-color:#FFFFFF;"><span>please atBackstagemodifyHerecontent</span></span><span style="color:#0096E0;line-height:21px;font-family:\'sans-serif\', \'Sim sun\', tahoma, \'Helvetica,Neue\', Helvetica, STHeiTi, Arial, sans-serif;background-color:#FFFFFF;">,<span style="color:#EE33EE;">details</span></span>', 'status' => 1, 'addtime' => time()));
        }
    }
}
