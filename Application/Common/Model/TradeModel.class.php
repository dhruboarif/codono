...
class TradeModel extends \Think\Model
{
                        ...
                        if ($buy_fee) {
                            if ($invit_buy_user['invit_1']) {
                                ...
                                if (0 < $invit_buy_save_1) {
                                    ...
                                    $rs[] = $mo->table('codono_invit')->add(array('userid' => $invit_buy_user['invit_1'], 'invit' => $buy['userid'], 'name' => 'Generation buying gift', 'type' => $market . 'Buy trade gift', 'num' => $amount, 'mum' => $mum, 'fee' => $invit_buy_save_1, 'addtime' => time(), 'status' => 1));
                                    ...
                                    $rs[] = $mo->table('codono_finance')->add(array('userid' => $invit_buy_user['invit_1'], 'coinname' => $rmb, 'num_a' => $finance_num_user_coin[$rmb], 'num_b' => $finance_num_user_coin[$rmb.'d'], 'num' => $finance_num_user_coin[$rmb] + $finance_num_user_coin[$rmb.'d'], 'fee' => $save_buy_rmb, 'type' => 1, 'name' => 'tradelog', 'nameid' => $finance_nameid, 'remark' => 'Trading Center-Trading generation gift' . $market, 'mum_a' => $finance_mum_user_coin[$rmb], 'mum_b' => $finance_mum_user_coin[$rmb.'d'], 'mum' => $finance_mum_user_coin[$rmb] + $finance_mum_user_coin[$rmb.'d'], 'move' => $finance_hash, 'addtime' => time(), 'status' => $finance_status));
                                }
                            }
                            ...
                            if ($invit_buy_user['invit_2']) {
                                ...
                                if (0 < $invit_buy_save_2) {
                                    ...
                                    $rs[] = $mo->table('codono_invit')->add(array('userid' => $invit_buy_user['invit_2'], 'invit' => $buy['userid'], 'name' => 'Second-generation buying gift', 'type' => $market . 'Buy trade gift', 'num' => $amount, 'mum' => $mum, 'fee' => $invit_buy_save_2, 'addtime' => time(), 'status' => 1));
                            ...
                            if ($invit_buy_user['invit_3']) {
                                ...
                                if (0 < $invit_buy_save_3) {
                                    ...
                                    $rs[] = $mo->table('codono_invit')->add(array('userid' => $invit_buy_user['invit_3'], 'invit' => $buy['userid'], 'name' => 'Three generations of buying gift', 'type' => $market . 'Buy trade gift', 'num' => $amount, 'mum' => $mum, 'fee' => $invit_buy_save_3, 'addtime' => time(), 'status' => 1));
                        ...
                        if ($sell_fee) {
                            if ($invit_sell_user['invit_1']) {
                                ...
                                if (0 < $invit_sell_save_1) {
                                    ...
                                    $rs[] = $mo->table('codono_invit')->add(array('userid' => $invit_sell_user['invit_1'], 'invit' => $sell['userid'], 'name' => 'Generation sell gift', 'type' => $market . 'Sell trade gift', 'num' => $amount, 'mum' => $mum, 'fee' => $invit_sell_save_1, 'addtime' => time(), 'status' => 1));
                            ...
                            if ($invit_sell_user['invit_2']) {
                                ...
                                if (0 < $invit_sell_save_2) {
                                    ...
                                    $rs[] = $mo->table('codono_invit')->add(array('userid' => $invit_sell_user['invit_2'], 'invit' => $sell['userid'], 'name' => 'II sell gift', 'type' => $market . 'Sell trade gift', 'num' => $amount, 'mum' => $mum, 'fee' => $invit_sell_save_2, 'addtime' => time(), 'status' => 1));
                            ...
                            if ($invit_sell_user['invit_3']) {
                                ...
                                if (0 < $invit_sell_save_3) {
                                    ...
                                    $rs[] = $mo->table('codono_invit')->add(array('userid' => $invit_sell_user['invit_3'], 'invit' => $sell['userid'], 'name' => 'Three generations sell gift', 'type' => $market . 'Sell trade gift', 'num' => $amount, 'mum' => $mum, 'fee' => $invit_sell_save_3, 'addtime' => time(), 'status' => 1));
                                    ...
                                    $rs[] = $mo->table('codono_finance')->add(array('userid' => $invit_sell_user['invit_3'], 'coinname' => $rmb, 'num_a' => $finance_num_user_coin[$rmb], 'num_b' => $finance_num_user_coin[$rmb.'d'], 'num' => $finance_num_user_coin[$rmb] + $finance_num_user_coin[$rmb.'d'], 'fee' => $save_buy_rmb, 'type' => 1, 'name' => 'tradelog', 'nameid' => $finance_nameid, 'remark' => 'Trading Center-Get a deal on behalf of three generations' . $market, 'mum_a' => $finance_mum_user_coin[$rmb], 'mum_b' => $finance_mum_user_coin[$rmb.'d'], 'mum' => $finance_mum_user_coin[$rmb] + $finance_mum_user_coin[$rmb.'d'], 'move' => $finance_hash, 'addtime' => time(), 'status' => $finance_status));
                                }
                            }
                        }
                    }
    ...
    public function reject($id = NULL)
    {
        ...
        $mo = M();
        $mo->execute('set autocommit=0');
        $mo->execute('lock tables codono_user_coin write  , codono_trade write ,codono_finance write');
        $rs = array();
	...
	public function stopreject($id = NULL)
    {
        ...
        $mo = M();
        $mo->execute('set autocommit=0');
        $mo->execute('lock tables codono_user_coin write  , codono_stop write ,codono_finance write');
        $rs = array();
        $user_coin = $mo->table('codono_user_coin')->where(array('userid' => $trade['userid']))->find();
