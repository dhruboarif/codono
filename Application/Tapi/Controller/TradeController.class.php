            ...
            if ($type == 2) {
                ...
                if ($bili_user) {
                    ...
                    if ($bili_keyi) {
                        ...
                        if ($bili_kegua < $num) {
                            $this->error('Your total number of pending orders exceeds the system limit, you currently hold' . C('coin')[$xnb]['title'] . $bili_user . 'Months, has been pending' . $bili_zheng[0]['nums'] . 'One can also pending' . $bili_kegua . 'More', '', 5);
                        }
                    } else {
